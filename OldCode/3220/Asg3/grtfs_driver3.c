...
// To Complile: gcc -g grtfs_1.c grtfs_2.c grtfs_driver2.c -o grtfs_driver2.out
//              (or use makefile)

// To Run: ./grtfs_driver2.out
//         (or use makefile)
...
int main(){
  ...
  sprintf( buffer1, "%s",
    "This is a simple-minded test for the GREAT file system code.  " );
...
/////////////////////////////////////////////////
  ...
  //Now we will attempt to make fd[1] unwriteable before trying to write to it
...
/////////////////////////////////////////////////
  ...
  if(!file_is_writable("my_file")){
    printf("my_file read in 0 bytes because it is unwritable\n" );
  }
  else{
    printf("Hey G, it didn't work my guy....\n");
  }
/////////////////////////////////////////////////
...
/////////////////////////////////////////////////
  ...
  if(!file_is_readable("file.txt")){
    printf("my_file had 0 bytes read because it is unreadable\n");
  }
  else{
    printf("Hey G, it didn't work my guy....\n");
  }
...
[test for the GREAT file system code.  ]
